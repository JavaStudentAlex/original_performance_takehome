...
2. `copilot-instructions.md` -- repo coding standards and tooling rules
...
6. **Repo guardrails**: Follow mandatory guardrails and quality gates from `AGENTS.md` and `copilot-instructions.md`.
