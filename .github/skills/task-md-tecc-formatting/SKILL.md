...
This skill treats `.github/copilot-instructions.md` as the **top-level contract**. If anything in this skill conflicts with it, follow `.github/copilot-instructions.md`.
...
- If repository guidance conflicts, follow `.github/copilot-instructions.md`.
